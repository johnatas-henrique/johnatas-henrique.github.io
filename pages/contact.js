    ...
    <Layout>
      ...
      >
        ...
        >
          <FormControl mt={3} w="100%" isInvalid={isNameError} isRequired>
            <FormLabel htmlFor="user_name" textAlign="center">
              Nome
            </FormLabel>
            <Input
              type="text"
          ...
          <FormControl w="100%" isInvalid={isEmailError} isRequired>
            <FormLabel htmlFor="user_email" textAlign="center">
              E-Mail
            </FormLabel>
            <Input
              type="email"
          ...
          <FormControl isInvalid={isMessageError} isRequired>
            <FormLabel htmlFor="user_message" textAlign="center">
              Mensagem
            </FormLabel>
            <Textarea
              id="user_message"
      ...
      <div className="text">
        <Heading as="h4" mt={8} mx={4} textAlign="justify">
          Se gostou do que viu ou deseja entrar em contato, fique à vontade que
          eu respondo o mais breve possível.
        </Heading>
        ...
        <Heading as="h5" display="flex" justifyContent="space-evenly" mt={10}>
          ...
          <Link
            target="_blank"
            w="10%"
            href="https://www.linkedin.com/in/johnatashenrique/"
          >
          ...
          <Link
            target="_blank"
            w="10%"
            href="https://github.com/johnatas-henrique"
          >
